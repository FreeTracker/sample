...
<div class="offcanvas-wrapper">
    <div class="container-fluid">
        <div class="row row-offcanvas row-offcanvas-left">
            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 sidebar-offcanvas"> @yield('left')</div>
            <div class="content col-xs-12 col-sm-12 col-md-12 col-lg-12 education">
...
<div class="container-fluid footer">
    <div class="row">
        <div class="col-md-12">
            2016 © <a href="{{ url('/') }}">TorrentHub.ru</a>
